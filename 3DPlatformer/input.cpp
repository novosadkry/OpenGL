...
void handleInput(GLFWwindow* window)
{
	...
	render::light->position->z -= (bKeyNum8 ? 2.0f : 0.0f) * render::deltaTime;
	render::light->position->z += (bKeyNum5 ? 2.0f : 0.0f) * render::deltaTime;
	render::light->position->x -= (bKeyNum4 ? 2.0f : 0.0f) * render::deltaTime;
	render::light->position->x += (bKeyNum6 ? 2.0f : 0.0f) * render::deltaTime;
	render::light->position->y += (bKeyNum2 ? 2.0f : 0.0f) * render::deltaTime;
	render::light->position->y -= (bKeyNum0 ? 2.0f : 0.0f) * render::deltaTime;
}
